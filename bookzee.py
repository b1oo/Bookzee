...
import csv
#deposits csv
deposits_2018 = 'Deposits_2018.csv'
extended_deposits = 'EtsyDirectCheckoutPayments2018.csv'
current_month = 'Feb_2018-2.csv'
...
with open(extended_deposits, 'r') as f:
  ...
  print('Net deposit minus materials in 2018: ')
